    ...
    <div className="container mt-2">
      <div className="grid grid-cols-12">
        <div className="col-span-10">
          ...
          <div style={{ margin: "0 auto" }}>{renderSeats()}</div>
        ...
        <div key={index} className="p-2 lg:w-1/2 md:w-1/2 w-full">
          <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg">
            ...
            <div className="flex-grow">
              <h2 className="text-red-600 text-4xl title-font font-medium">
                {ticket.tenPhim}
              </h2>
              <p className="text-yellow-500 text-2xl font-bold">
                <span className="text-black text-lg">Giờ chiếu: </span>
                {moment(ticket.ngayDat).format("hh:mm A")} -
                <span className="text-black text-lg"> Ngày chiếu:</span>{" "}
